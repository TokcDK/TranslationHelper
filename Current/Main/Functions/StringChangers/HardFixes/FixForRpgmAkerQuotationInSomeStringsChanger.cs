...
{
    class FixForRpgmAkerQuotationInSomeStringsChanger : StringChangerBase
    {
        public FixForRpgmAkerQuotationInSomeStringsChanger()
        {
        }
        internal override string Description => $"{nameof(FixForRpgmAkerQuotationInSomeStringsChanger)}";


        internal override string Change(string inputString, object extraData)
        {
            var newtransValue = inputString;
            var ret = false;
