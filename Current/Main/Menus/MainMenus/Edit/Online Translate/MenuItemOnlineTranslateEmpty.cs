...
{
    internal class MenuItemOnlineTranslateEmpty : MainMenuFileSubItemOnlineTranslateBase, IFileRowMenuItem, IFileListMenuItem, IProjectMenuItem
    {
        ...
        protected virtual ParameterizedThreadStart Param { get => (obj) => new Functions.FileElementsFunctions.Row.OnlineTranslate.OnlineTranslateNewEmpty().All(); }
    }
}
