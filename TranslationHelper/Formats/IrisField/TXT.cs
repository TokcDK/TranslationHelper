    ...
    class TXT : FormatStringBase
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else if (IsValidString(mergedMessage))
                    {
                        ...
                        {
                            //split lines
                            var newLine = mergedMessage.SplitMultiLineIfBeyondOfLimit(MaxLineLength);//37 if transform all en chars to jp variants
        ...
        private void ParseChoices()
        {
            ...
            for (int i = 0; i < choicesCount; i++)
            {
                ...
                if (AddRowData(RowData: ref choiceText, RowInfo: "Choice: " + i) && AppData.SaveFileMode)
                {
