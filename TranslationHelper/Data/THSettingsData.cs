...
namespace TranslationHelper.Data
{
    internal class THSettingsData
    {
        ...
        {
            return "((イクう*[ーっッ]*)|(く?ちゅ)|(びゅる+[ーっ]*)|(びゅ[ぐく])|(んは[ぁあ]+[ーっン]*)|(ん[ぅう…]*え…*っ)|(ん?…*[ふぅう]+[ぁあ]*[ーっ]*)|(ふ[ぅう]+[ーっ]*)|(う[んぁあ]+[ーっン]*)|(んゃ+[ぁあ]*[ーっン]*)|(ん[ぁあ]*[ーっン]*)|([あは]+[ーっ]*)|(く、?[ぅう]+[ーっン]*)|([ぅう]+[ーっ]*)|(ひん+[ーっ]*)|(ふ+…+[ーっ]*)|([ぁあ]+[ーっン]*)|(くっ)|(んく)|(ひ[ーっ]*))+";
        }
    }
}
