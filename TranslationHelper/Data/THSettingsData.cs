...
namespace TranslationHelper.Data
{
    internal class THSettingsData
    {
        ...
        {
            return "(((ぴちゃ)|(にちゅ)|(くにゅ)|(にゅく)|(くちゅ)|(ちゅぷ)|(ぢゅる+)|(にゅっ?ぷ)|([クヌプ]チュ)|([ぷぴぬずぐ]ちゅ)|(ぬるぅ)|(ぴゅ)|(くち)|(くっ)|(んく)|(ちゅ)|(イクう*)|(びゅる+)|(ぬぷ+)|(ドチュル+ゥ)|(ブ?(ビュ)+ゥ*)|(びゅ[ぐく])|(ん?は[ぁあ]+[ーっンッ]*)|(ん[ぅう…]*え)|(ん?…*[ふぅう]+[ぁあ]*)|(ふ[ぅう]+)|(う[んぁあ]+[ーっン]*)|(んゃ+[ぁあ]*[ーっン]*)|(ん[ぁあ]*[ーっン]*)|([あは]+)|(く、?[ぅう]+[ーっン]*)|([ぅう]+)|(ひん+)|(ふ+…+)|(や?[ぁあ]+[ーっン]*)|(ッ+)|(く+)|(ひ+))[、…ーっッ]*)+";
        }
    }
}
