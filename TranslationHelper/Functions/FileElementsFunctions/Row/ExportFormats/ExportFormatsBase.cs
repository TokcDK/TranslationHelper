...
namespace TranslationHelper.Functions.FileElementsFunctions.Row.ExportFormats
{
    ...
    {
        protected ExportFormatsBase(ProjectData projectData) : base(projectData)
        {
        }
        ...
        protected override bool Apply()
        {
            ...
            AllRows.Add(OriginalMod(SelectedRow[0]+"") + MarkerTranslation + TranslationMod(SelectedRow[1]+""));
