...
namespace TranslationHelper.INISettings
{
    class SSearchRowIssueOptionsCheckActors : Tools
    {
        ...
        object SObject { get => AppData.Settings.cbSearchRowIssueOptionsCheckActors; }

        static bool SVar
        {
            get => AppSettings.SearchRowIssueOptionsCheckActors;
            set => AppSettings.SearchRowIssueOptionsCheckActors = value;
        }
