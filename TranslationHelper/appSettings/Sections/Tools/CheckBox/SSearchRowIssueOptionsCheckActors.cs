...
namespace TranslationHelper.INISettings
{
    ...
    {
        public SSearchRowIssueOptionsCheckActors(THDataWork thDataWork) : base(thDataWork)
        {
        }
        ...
        object SObject { get => thDataWork.Main.Settings.cbSearchRowIssueOptionsCheckActors; }
