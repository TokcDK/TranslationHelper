...
namespace TranslationHelper.INISettings
{
    ...
    {
        public SSearchRowIssueOptionsCheckNonRomaji(THDataWork thDataWork) : base(thDataWork)
        {
        }
        ...
        object SObject { get => thDataWork.Main.Settings.cbSearchRowIssueOptionsCheckNonRomaji; }
