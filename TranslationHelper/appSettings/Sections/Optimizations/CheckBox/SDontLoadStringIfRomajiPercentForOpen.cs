...
namespace TranslationHelper.INISettings
{
    ...
    {
        public SDontLoadStringIfRomajiPercentForOpen(ProjectData projectData) : base(projectData)
        {
        }
        ...
        object SObject { get => projectData.Main.Settings.THOptionDontLoadStringIfRomajiPercentForOpenCheckBox; }

        static bool SVar
        {
            get => TranslationHelper.Properties.Settings.Default.DontLoadStringIfRomajiPercentForOpen;
            set => TranslationHelper.Properties.Settings.Default.DontLoadStringIfRomajiPercentForOpen = value;
        }
