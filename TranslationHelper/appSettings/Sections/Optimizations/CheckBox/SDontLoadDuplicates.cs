...
namespace TranslationHelper.INISettings
{
    ...
    {
        public SDontLoadDuplicates(THDataWork thDataWork) : base(thDataWork)
        {
        }
        ...
        object SObject { get => thDataWork.Main.Settings.THOptionDontLoadDuplicates; }

        static bool SVar
        {
            get => TranslationHelper.Properties.Settings.Default.DontLoadDuplicates;
            set => TranslationHelper.Properties.Settings.Default.DontLoadDuplicates = value;
        }
